...
*/
/*Modified to return the same points received when format is passed to hull*/
export default hull;
...
function hull(pointset, concavity, format) {
    ...
    const points = _filterDuplicates(_sortByX(_toXy(pointset, format)));
